...
void LBFGS1(float ** taper_coeff, int nsrc, float ** srcpos, int ** recpos, int ntr_glob, int iter, int nfstart_jac, float ** waveconv_u, float C_vs, float ** gradp_u, float ** waveconv_rho, float C_rho, float ** gradp_rho, float * y_LBFGS, float * s_LBFGS, float * rho_LBFGS, 
            float * alpha_LBFGS, float ** pu, float ** prho, int nxnyi, float * q_LBFGS, float * r_LBFGS, float * beta_LBFGS, int LBFGS_pointer, int NLBFGS, int NLBFGS_vec){
...
if(iter>1){
   ...
   /* load old models and gradients - Rho and save them into the LBFGS vectors */
   /* ------------------------------------------------------------------------ */
   ...
   /* load old models and gradients - Vs and save them into the LBFGS vectors */
   /* ----------------------------------------------------------------------- */
