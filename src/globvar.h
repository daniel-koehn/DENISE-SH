...
int HESSIAN, GRAD_METHOD, ORDER_HESSIAN, PCG_BETA;
float FC_HESSIAN, FC_HESS_START, FC_HESS_INC;
...
/* parameter for step length scaling */
float SCALERHO;

/* define gradient formulation */
int GRAD_FORM;

/* global definition of average material parameters */
float C_rho, C_vs;
