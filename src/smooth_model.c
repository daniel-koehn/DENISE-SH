...
void smooth_model(float ** pu, float ** prho, int iter)
{
	...
	float **model_tmp_vs, **model_med_vs, **model_tmp_rho, **model_med_rho, **filterpart_rho, **filterpart_vs, grad, normgauss, smooth_meter;
